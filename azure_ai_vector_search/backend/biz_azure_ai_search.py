...
from backend.azure_ai_vector_search import CustomAzureSearch
...
def get_results_vector_search(
    ...
    custom_azure_search = CustomAzureSearch(
        ...
        ai_endpoint=AZURE_OPENAI_ENDPOINT,
        ai_key=AZURE_OPENAI_KEY,
        ai_model=AZURE_OPENAI_EMBEDDING_DEPLOYMENT_ID,
