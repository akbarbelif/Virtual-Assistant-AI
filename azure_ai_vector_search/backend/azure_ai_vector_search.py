...
class CustomAzureSearch:
    def __init__(self,
        ...
        self.ai_client = AzureOpenAI(
                    ...
                    azure_endpoint = self.ai_endpoint
                    )
    ...
    def get_embedding_query_vector(self, query):
        ...
        """
        ## This results 384 Dimensional Size
        # model = SentenceTransformer(self.model_name)
        # query_vector = model.encode(query)
        ## This results 1536 Dimensional Size
        print(query)
        query_vector = self.ai_client.embeddings.create(input = [query], model=self.ai_model).data[0].embedding
        return query_vector
